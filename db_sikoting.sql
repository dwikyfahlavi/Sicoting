...
(6, 'Abstraksi', 'ini adalah abstraksi', NULL, NULL, 'opsi a', 'opsi b', 'opsi c', 'opsi d', 'opsi e', '1', NULL, 1),
(7, 'Pengenalan Pola', 'ini adalah abstraksi', NULL, NULL, 'opsi a pola', 'opsi b pola', 'opsi c pola', 'opsi d pola', 'opsi e pola', '0', NULL, 1),
(8, 'Algoritma', 'naon wen pokokna algoritma', NULL, NULL, 'dsa', 'qwe', 'zxc', 'sdf', 'ewr', '1', NULL, 1);
...
ALTER TABLE `hasil_siswa`
  ...
  ADD KEY `fk_hasil_materi` (`id_submateri`) USING BTREE;
...
--
ALTER TABLE `hasil_siswa`
  MODIFY `id_hasil_siswa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202;
...
--
ALTER TABLE `sub_soal_latihan`
  MODIFY `id_sub_latihan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `hasil_siswa`
  ADD CONSTRAINT `fk_hasil_materi` FOREIGN KEY (`id_submateri`) REFERENCES `submateri` (`id_submateri`) ON DELETE CASCADE ON UPDATE CASCADE,
