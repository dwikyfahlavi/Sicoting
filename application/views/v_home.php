  ...
  <div class="row justify-content-center">
	...
	<h1>Sistem Pembelajaran Computational Thinking</h1>
        <h2>Belajar memecahkan masalah menggunakan konsep
          Berpikir Komputasi (Computational Thinking) dengan
          tahapan Problem Based Learning.</h2>
	  <div><a href="<?php echo site_url('Auth'); ?>" class="btn-get-started scrollto">Get Started</a></div>
	</div>
...
<main id="main">
  ...
  <!-- ======= Why Us Section =======
  <section id="pbl1" class="why-us section-bg">
    <div class="container-fluid" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
          ...
          <div class="content">
            <h3>Computational Thinking atau Berpikir Komputasi</strong></h3>
            <p>
...
<section id="about" class="services section-bg">
  <div class="container" data-aos="fade-up">
	...
	<h2>About SICOTING</h2>
        <p>SICOTING merupakan sistem pembelajaran computational thinking berbasis website. Dalam website ini, anda akan belajar memecahkan permasalahan dengan tahapan computational thinking
          yang terdiri dari Dekomposisi, Abstraksi, Pengenalan Pola, dan Berpikir Algoritma. Selain itu, anda akan belajar mengikuti 5 tahapan belajar Problem Based Learning.
