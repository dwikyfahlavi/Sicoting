            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?= form_open_multipart('guru/editProfileRespon') ?>
                            ...
                            <div class="form-group">
                                <label>NIP</label>
                                <input type="text" class="form-control" name="nip" value="<?= $editProfile->nip ?>">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="mapel" value="<?= $editProfile->mapel ?>">
                            </div>
                            <div class="form-group">
                                <label>Foto</label>
