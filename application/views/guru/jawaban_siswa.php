    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<?= site_url("guru/hasilLatihan/" . $breadcrump['id_latihan'] . '/' . $subMateri['id_submateri']); ?>">Soal CT</a></div>
            ...
            <div class="col-lg">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-icon icon-left btn-primary" onclick="tambahSoal(2,1,'Dekomposisi')" id="tambah_soal"><i class="fas fa-plus"></i> Nilai</button>
                        <br><br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" class="form-control" name="id_hasil_siswa" id="id_hasil_siswa" value="<?php echo $hasils['id_hasil_siswa']; ?>">
