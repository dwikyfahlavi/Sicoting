                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($latihan as $m) : ?>
                                        <tr>
                                            ...
                                            <td style="width:30%">
                                                <a href="<?php echo site_url('guru/editSubLatihan/' . $m['id_sub_latihan'] . '/' . $subMateri['id_submateri']);?>" class="btn btn-icon icon-left btn-primary"><i class="fas fa-info-circle"></i>Edit</a>
