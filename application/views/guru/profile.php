                        ...
                        <div class="card-body">
                            <div class="author-box-left">
                                <div class="user-item">
                                    ...
                                    <div class="user-details">
                                        ...
                                        <div class="text-job text-muted" style="font: size 16pt;"><?= $user['mapel'] ?></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="author-box-details">
                                <div class="author-box-description" style="margin-left: 150px;">
                                    ...
                                    <br>
                                    <div class="text-medium font-weight-bold" style="font-size: 14pt ;">NIP: <?= $user['nip'] ?> </div>
                                    <br>
                                ...
                                <div class="float-right mt-sm-0 mt-3">
                                    <a href="<?= site_url('guru/editProfile/' . $user['id_user']); ?>" class="btn btn-info">Edit Profile</a>
                                </div>
                            </div>
                        </div>
                    </div>
