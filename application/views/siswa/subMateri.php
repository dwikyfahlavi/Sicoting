    ...
    <div class="modal-content" >
      ...
      <div class="modal-body">
        <div class="column">
            ...
            <button type="button" class="btn btn-warning" style="width: 50%;"  onclick="showModalSecc(1)">Kompetensi Dasar</button><br>
            <button type="button" class="btn btn-warning" style="width: 50%;" onclick="showModalSecc(2)">Indikator Pencapaian Kompetensi</button><br>
            <button type="button" class="btn btn-warning" style="width: 50%;" onclick="showModalSecc(3)">Tujuan Pembelajaran</button>
        </div>
      </div>
